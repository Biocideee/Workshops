...
int main(void)
{
  ...
  while (1)
  {
      if (play_count < 3)
      {
          ...
          CS43L22_Beep(NOTE_C5, 150);
          CS43L22_Beep(NOTE_D5, 150);
          CS43L22_Beep(NOTE_F5, 150);
          CS43L22_Beep(NOTE_D5, 150);
          ...
          CS43L22_Beep(NOTE_E5, 300);
		  CS43L22_Beep(NOTE_E5, 400);
		  CS43L22_Beep(NOTE_D5, 500);
		  CS43L22_Beep(NOTE_C5, 500);
		  ...
		  CS43L22_Beep(NOTE_C5, 300);
		  CS43L22_Beep(NOTE_F5, 500);
		  CS43L22_Beep(NOTE_C5, 600);
		  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_14 | GPIO_PIN_13, GPIO_PIN_RESET);
